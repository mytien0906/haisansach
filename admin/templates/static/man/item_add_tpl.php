                                    ...
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                        <?php foreach($config['website']['lang'] as $k => $v) { ?>
                                            <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php } ?>
                                                <?php if(isset($config['static'][$type]['dongia1']) && $config['static'][$type]['dongia1'] == true && $k=='vi') { ?>
                                                    <div class="form-group">
                                                        <label for="dongia1">Đơn giá nhà phố liên kề:</label>
                                                        <input type="text" class="form-control format-price for-seo" name="data[dongia1]" id="dongia1" placeholder="Đơn giá nhà phố liên kề" value="<?=@$item['dongia1']?>">
                                                    </div>
                                                <?php } ?>
                                                <?php if(isset($config['static'][$type]['dongia2']) && $config['static'][$type]['dongia2'] == true && $k=='vi') { ?>
                                                    <div class="form-group">
                                                        <label for="dongia2">Đơn giá biệt thự, Văn phòng, Khách sạn:</label>
                                                        <input type="text" class="form-control format-price for-seo" name="data[dongia2]" id="dongia2" placeholder="Đơn giá biệt thự, Văn phòng, Khách sạn" value="<?=@$item['dongia2']?>">
                                                    </div>
                                                <?php } ?>
                                                <?php if(isset($config['static'][$type]['dongia3']) && $config['static'][$type]['dongia3'] == true && $k=='vi') { ?>
                                                    <div class="form-group">
                                                        <label for="dongia3">Đơn giá công trình khác:</label>
                                                        <input type="text" class="form-control for-seo" name="data[dongia3]" id="dongia3" placeholder="Đơn giá công trình khác" value="<?=@$item['dongia3']?>">
                                                    </div>
                                                <?php } ?>
