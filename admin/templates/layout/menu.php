                ...
                <!-- <?php $disabled = array();
                    ...
                    <li class="nav-item has-treeview menu-group">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (isset($value['translate'])) {
                                    foreach ($value['translate'] as $k) { ?>
                                <?php
                            ...
                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if (isset($v['xuatxu']) && $v['xuatxu'] == true) {
                                        ...
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_xuatxu&type=<?= $k ?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Xuất xứ</p>
                                            </a></li>
                                    <?php } ?>
                                    <?php if (isset($v['tieuchuan']) && $v['tieuchuan'] == true) {
                                        ...
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_tieuchuan&type=<?= $k ?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Bảo hành</p>
                                            </a></li>
                                    <?php } ?>
                                    <?php if (isset($v['mau']) && $v['mau'] == true) {
