                ...
                <?php $disabled = array(); if(isset($config['group'])) { foreach($config['group'] as $key => $value) { ?>
                    <li class="nav-item has-treeview menu-group">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php } } ?>
                            <?php if(isset($value['translate'])) { foreach($value['translate'] as $k) { ?>
                                <?php
                                $disabled['translate'][$k] = 1;
                                $v = $config['translate'][$k];
                                $none = "";
                                $active = "";
                                if(isset($kiemtra) && $kiemtra == true) if($func->check_access('translate', 'man', $k, null, 'phrase-1')) $none = "d-none";
                                if($com=='translate' && $k==$_GET['type']) $active = "active";
                                ?>
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=translate&act=man&type=<?=$k?>" title="<?=$v['title_main']?>"><i class="nav-icon text-sm far fa-caret-square-right"></i><p><?=$v['title_main']?></p></a>
                                </li>
                            <?php } } ?>
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($v['brand']) && $v['brand'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_brand&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Thương hiệu</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['xuatxu']) && $v['xuatxu'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_xuatxu', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_xuatxu' || $act=='add_xuatxu' || $act=='edit_xuatxu') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_xuatxu&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Xuất xứ</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['tieuchuan']) && $v['tieuchuan'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_tieuchuan', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_tieuchuan' || $act=='add_tieuchuan' || $act=='edit_tieuchuan') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_tieuchuan&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Bảo hành</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['mau']) && $v['mau'] == true) {
                                    $none = "";
                                    $active = "";
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.menu-group').each(function(index, element) {
            let check_group=0;
            $(this).find('.nav-treeview').find('.nav-item ').each(function(index, element) {
