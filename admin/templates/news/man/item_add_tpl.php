                                            ...
                                            <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php if (isset($config['news'][$type]['solieu']) && $config['news'][$type]['solieu'] == true && $k == 'vi') { ?>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" class="form-control" name="data[solieu]" id="solieu" placeholder="Nhập số liệu" value="<?= @$item['solieu'] ?>" required>
                                                    </div>
                                                <?php } ?>
                                                <?php if (isset($config['news'][$type]['congviec']) && $config['news'][$type]['congviec'] == true && $k == 'vi') { ?>
                                                    <div class="form-group">
                                                        <label for="congviec">Công việc:</label>
                                                        <input type="text" class="form-control" name="data[congviec]" id="congviec" placeholder="Nhập công việc" value="<?= @$item['congviec'] ?>">
                                                    </div>
                                                <?php } ?>
                                    ...
                                    <?php if (isset($config['news'][$type]['dropdown']) && $config['news'][$type]['dropdown'] == true) { ?>
                                        <?php if (isset($config['news'][$type]['list']) && $config['news'][$type]['list'] == true) { ?>
                                            <div class="form-group col-xl-6 col-sm-4">
                                                <label class="d-block" for="id_list">Chính sách quy định chung</label>
                    ...
                    <div class="card card-primary card-outline text-sm ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-mini d-inline-block align-middle" min="0" name="data[stt]" id="stt" placeholder="Số thứ tự" value="<?= isset($item['stt']) ? $item['stt'] : $mstt ?>">
                            </div>
                        </div>
                    </div>
